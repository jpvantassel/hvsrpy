...
#         cls.hv = hvsrpy.HvsrTraditional(amp, frq)
...
#         myhvsr = hvsrpy.HvsrTraditional(amp, frq)
...
#         hvsr = hvsrpy.HvsrTraditional(amp, frq, f_low=None, f_high=4, find_peaks=True)
#         self.assertArrayEqual(np.array([3.0]), hvsr.peak_frq)

#         # amp as 1d array - two peak
#         frq = np.array([1, 2, 3, 4, 5, 6, 7, 8])
#         amp = np.array([[1, 1, 2, 1, 1, 5, 1, 1]])
#         hvsr = hvsrpy.HvsrTraditional(amp, frq, f_low=4, f_high=None, find_peaks=True)
#         self.assertArrayEqual(np.array([6.0]), hvsr.peak_frq)

#         # amp as 1d array - two peak
#         frq = np.array([1, 2, 3, 4, 5, 6, 7, 8])
#         amp = np.array([[1, 1, 2, 1, 1, 5, 1, 1]])
#         hvsr = hvsrpy.HvsrTraditional(amp, frq, f_low=1, f_high=8, find_peaks=True)
#         self.assertArrayEqual(np.array([6.0]), hvsr.peak_frq)

#         # amp as 1d array - two peak
#         frq = np.array([1, 2, 3, 4, 5, 6, 7, 8])
#         amp = np.array([[1, 1, 2, 1, 1, 5, 1, 1]])
#         hvsr = hvsrpy.HvsrTraditional(amp, frq, f_low=None, f_high=None, find_peaks=True)
#         self.assertArrayEqual(np.array([6.0]), hvsr.peak_frq)
...
#         myhv = hvsrpy.HvsrTraditional(amp, frq)
...
#                         [3, 4],
#                         [5, 7]])
#         myhv = hvsrpy.HvsrTraditional(amp, frq, find_peaks=False)
...
#         frq = [1, 2]
#         amp = [1, 2]
#         _hv = hvsrpy.HvsrTraditional(amp, frq, find_peaks=False)
...
#                         [1, 1, 1, 1, 6],
#                         [1, 1, 1, 6, 1]])
#         hv = hvsrpy.HvsrTraditional(amp, frq)
...
#         amp[np.arange(10), col] = 2
#         myhv = hvsrpy.HvsrTraditional(amp, frq, find_peaks=False, meta={})
#         myhv.reject_windows(n=2)
